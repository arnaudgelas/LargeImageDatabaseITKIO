...
#include "itkMySQLDataBaseImageIO.h"
#include "itksys/SystemTools.hxx"

namespace itk
{

MySQLDataBaseImageIO::MySQLDataBaseImageIO()
{
}
...
void MySQLDataBaseImageIO::PrintSelf(std::ostream& os, Indent indent) const
{
  Superclass::PrintSelf(os, indent);
}

bool MySQLDataBaseImageIO::CanReadFile( const char* filename )
{
  // FIXME Implement
  return true;
}
...
void MySQLDataBaseImageIO::ReadImageInformation()
{
...
void MySQLDataBaseImageIO::Read( void * buffer)
{
...
bool MySQLDataBaseImageIO::CanWriteFile( const char * name )
{
  //
  // MySQLDataBase is not implemented to write yet.
  // It will be soon...
  //
  return false;
}
